...
#define ZJ_CAST_JSON_VAR_MAP_ARRAY_OF_STRING	(zetjsoncpp::MapArrayStringJsonVar<> *)
...
#define ZJ_VAR_MAP_ARRAY_STRING(type,name) zetjsoncpp::MapArrayStringJsonVar<type,ZJ_CONST_CHAR(#name)>		name
